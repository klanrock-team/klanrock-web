...
<section class="content-header">
    <h1>
        paket photo for <?php echo $paket['nama_paket'];?>
        <small>preview</small>
    </h1>
    <ol class="breadcrumb">
...
<?php echo form_open('paket/proses_gambar',array('id'=>'form_upload','enctype'=>'multipart/form-data'))?>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="col-md-6">
                        ...
                        <?php echo @$paket['nama_paket']?><br><br>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <?php
                                            ...
                                            foreach (@$gambar as $value) {?>
                                                <div class="col-md-4 col-sm-4 galery">
                                                    <a href="<?php echo base_url()?>assets/images/<?php echo $value->nama_gambar?>" data-fancybox="group" data-caption="<?php echo $paket['nama_paket']?> - photo<?php echo $i?>" >
                                    ...
                                    <br><br><a href="<?php echo base_url()?>paket/"><button type="button" class="btn btn-default"><i class="fa fa-backward"></i> Kembali</button></a>
                                </div>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.box-body -->
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //     e.preventDefault(); 
        //         $.ajax({
        //             url:'<?php echo base_url();?>upload/paket/do_upload',
        //             type:"post",
